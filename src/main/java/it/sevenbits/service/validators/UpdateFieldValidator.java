...
public class UpdateFieldValidator {
    ...
    public HashMap<String, String> validate(final UpdateUserForm form) {
        ...
        validator.shorterThan(form.getFirstName(), 50, errors,
                "Поле имя", "Поле имя должно быть короче 50 символов");
        validator.isImage(form.getImageUrl(), errors, "", "");
        validator.shorterThan(form.getPhone(), 50, errors,
                "Поле телефон", "Поле телефон должно быть короче 50 символов");
