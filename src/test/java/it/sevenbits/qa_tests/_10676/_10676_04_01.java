...
// Проверка на ввод в поле "Название" строки символов длиной 256 латинских символов на странице подачи объявления
public class _10676_04_01 extends TestCase{
  ...
  @Test
  public void test106760401() throws Exception {
    ...
    // Warning: verifyTextPresent may require manual changes
      try {
          assertEquals("Поле Название объявления не может быть больше 255 символов", driver.findElement(By.cssSelector("p")).getText());
      } catch (Error e) {
          verificationErrors.append(e.toString());
      }
  }
