...
// Проверка на ввод в поле названия инвентаря 256 латинских букв на странице подачи объявления
public class _10676_04_01 extends TestCase{
  ...
  public void test106760401() throws Exception {
    ...
    try {
      assertEquals("Поле название не может быть длиннее 255 символов", driver.findElement(By.cssSelector("p")).getText());
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
  }
