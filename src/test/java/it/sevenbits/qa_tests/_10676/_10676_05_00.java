...
// Проверка на пустой ввод в поле описания на странице подачи объявления
public class _10676_05_00 extends TestCase{
  ...
  @Test
  public void test106760500() throws Exception {
    ...
    try {
      assertEquals("Поле описание не может быть пустым", driver.findElement(By.cssSelector("p")).getText());
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
  }
