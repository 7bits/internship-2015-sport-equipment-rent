...
// Проверка на ввод в поля "Цена..." строк, содержащих буквы
public class _10676_06_02 extends TestCase{
  ...
  @Test
  public void test106760602() throws Exception {
    ...
    driver.findElement(By.id("PriceForHour")).sendKeys("абв");
    driver.findElement(By.id("PriceForDay")).clear();
    driver.findElement(By.id("PriceForDay")).sendKeys("abc");
    driver.findElement(By.id("PriceForWeek")).clear();
    driver.findElement(By.id("PriceForWeek")).sendKeys("тест");
