...
// Проверка работоспособности ссылки "Личный кабинет"
public class _10676_09_00 extends TestCase {
  ...
  @Test
  public void test106760900() throws Exception {
      ...
      try {
      assertTrue(isElementPresent(By.xpath("//div[2]/a/b/p")));
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    driver.findElement(By.xpath("//div[2]/a/b/p")).click();
    try {
