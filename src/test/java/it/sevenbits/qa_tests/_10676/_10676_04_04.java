...
// Проверка на ввод в поле "Название" строки символов (латинские, русские, спецсимволы, цифры) длиной 200 символов
public class _10676_04_04 extends TestCase{
    ...
    @Test
    public void test106760404() throws Exception {
        ...
        driver.findElement(By.id("from")).sendKeys("какое-то описание some text with descriptionкакое-то описание some text with descripкакое-то описание some t1234567890escripкакое-то опи!#@№;%:?*()text with descripкакое-то описание some text with rip");
        driver.findElement(By.id("announcementsDescription")).clear();
        driver.findElement(By.id("announcementsDescription")).sendKeys("");
