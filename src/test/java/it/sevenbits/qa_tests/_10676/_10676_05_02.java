...
// Проверка на ввод в поле описания 2048 русских букв на странице подачи объявления
public class _10676_05_02 extends TestCase{
  ...
  @Test
  public void test106760502() throws Exception {
    ...
    driver.findElement(By.id("from")).sendKeys("Особое название");
    for (int second = 0;; second++) {
    	if (second >= 60) fail("timeout");
    ...
    try {
      ...
      try {
          assertEquals("Особое название", driver.findElement(By.cssSelector("div.b-list-announcements-elem-product-info__discription.js-cut-text > p")));
      } catch (Error e) {
          verificationErrors.append(e.toString());
      }
