...
// Проверка на ввод в поле "Описание" строки из 2049 символов латинского алфавита
public class _10676_05_01 extends TestCase{
    ...
    public void test106760501() throws Exception {
        ...
        driver.findElement(By.id("announcementsDescription")).sendKeys(
                        ...
                        "test test test test test test test test test test test test test" +
                        "test test test test test test test test test test test test test" +
                        "test test test test test test test test test test test test test" + "q"
        );
        ...
        try {
            assertEquals("Поле Описание объявления не может быть больше 2048 символов", driver.findElement(By.cssSelector("p")).getText());
        } catch (Error e) {
            verificationErrors.append(e.toString());
        }
    }
