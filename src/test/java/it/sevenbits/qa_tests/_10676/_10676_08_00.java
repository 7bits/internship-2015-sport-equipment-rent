...
// Проверка на работоспособность логотипа на странице подачи объявления
public class _10676_08_00 extends TestCase {
  ...
  @Test
  public void test106760800() throws Exception {
    ...
    try {
      assertTrue(isElementPresent(By.cssSelector("div.b-logo")));
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    driver.findElement(By.cssSelector("div.b-logo")).click();
    for (int second = 0;; second++) {
    	if (second >= 60) fail("timeout");
    	try { if ("Дай погонять".equals(driver.getTitle())) break; } catch (Exception e) {}
    	Thread.sleep(1000);
    }
