...
// Проверка на ввод в поле "Название" 254 букв кириллицы
public class _10676_04_03 extends TestCase{
  ...
  @Test
  public void test106760403() throws Exception {
    ...
    driver.findElement(By.id("from")).sendKeys("ОписаниеОписаниеОписаниеОписаниеОписаниеОписаниеОписаниеОписание" +
            "ОписаниеОписаниеОписаниеОписаниеОписаниеОписаниеОписаниеОписание" +
            "ОписаниеОписаниеОписаниеОписаниеОписаниеОписаниеОписаниеОписание" +
            "ОписаниеОписаниеОписаниеОписаниеОписаниеОписаниеОписаниеОписан");
    driver.findElement(By.id("announcementsDescription")).clear();
    driver.findElement(By.id("announcementsDescription")).sendKeys("Описание");
    ...
    // Warning: verifyTextPresent may require manual changes
      try {
          assertEquals("Поле Название объявления не может содержать больше 255 символов", driver.findElement(By.cssSelector("p")).getText());
      } catch (Error e) {
          verificationErrors.append(e.toString());
      }
  }
