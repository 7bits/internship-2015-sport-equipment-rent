...
//Проверка на ввод e-mail, начинающегося с "_" (страница авторизации)
public class _10571_02_07 extends TestCase {
  ...
  @Test
  public void test105710207() throws Exception {
    driver.get(baseUrl + "/login");
    driver.findElement(By.id("userEmail")).clear();
    driver.findElement(By.id("userEmail")).sendKeys("_test1@gmail.com");
