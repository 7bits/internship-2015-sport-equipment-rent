...
//Проверка на ввод e-mail длиной >50 символов (страница авторизации)
public class _10571_02_05 extends TestCase {
  ...
  @Test
  public void test105710205() throws Exception {
    driver.get(baseUrl + "/login");
    driver.findElement(By.id("userEmail")).clear();
    driver.findElement(By.id("userEmail")).sendKeys("testtesttesttesttesttesttesttesttesttesttesttest@gmail.com");
