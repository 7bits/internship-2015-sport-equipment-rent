...
// Проверка на ввод имени длиной 51 символов (латиница) на странице регистрации
public class _10666_01_02 extends TestCase {
  ...
  public void test106660102() throws Exception {
    ...
    driver.findElement(By.id("name")).sendKeys("testtesttesttesttesttesttesttesttesttesttesttesttes");
