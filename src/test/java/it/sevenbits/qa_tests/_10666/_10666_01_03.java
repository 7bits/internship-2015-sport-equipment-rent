...
// Проверка на ввод имени длиной 50 символов (кириллица) на странице регистрации
public class _10666_01_03 extends TestCase {
  ...
  @Test
  public void test106660102() throws Exception {
    driver.get(baseUrl + "registration");
    driver.findElement(By.id("name")).clear();
    driver.findElement(By.id("name")).sendKeys("тесттесттесттесттесттесттесттесттесттесттесттестте");
