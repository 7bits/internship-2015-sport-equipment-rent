...
// Проверка на ввод email длиной >50 символов на странице регистрации
public class _10666_02_07 extends TestCase {
  ...
  @Test
  public void test106660207() throws Exception {
    driver.get(baseUrl + "registration");
    driver.findElement(By.id("name")).clear();
    driver.findElement(By.id("name")).sendKeys("test");
    driver.findElement(By.id("userEmail")).clear();
    driver.findElement(By.id("userEmail")).sendKeys("memememememememememememememememememememememememe@test.com");
